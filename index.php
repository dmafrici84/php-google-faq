...
<?php
  ...
  // var_dump($database);
  foreach ($database as $keys => $value) {
    ?>
    <h2 style=max-width:978px;margin-left:auto;margin-right:auto;padding-top:64px;padding-left:16px;padding-right:16px;color:#3c4043;font-size:27px;line-height:32px;>
      <?php echo $value["domanda"]; ?>
    </h2>
    <?php

    foreach ($value["risposta"] as $risp) {
      ?>
      <p style=max-width:978px;margin-top:10px;margin-bottom:10px;margin-left:auto;margin-right:auto;padding-top:20px;padding-left:16px;padding-right:16px;color:rgba(0,0,0,0.87);font-size:15.5px;line-height:24px;letter-spacing:.2px;>
        <?php echo $risp; ?>
      <p>
      <?php
